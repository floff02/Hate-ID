...
import com.example.hateidapp.databinding.ActivityQuestionnaireBinding;
...
public class ReferralPathway extends AppCompatActivity {
    ...
    ActivityReferralPathwayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReferralPathwayBinding.inflate(getLayoutInflater());
        ...
        binding.imgbtnAboutus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReferralPathway.this,ReferralPathway.class));
            }
        });
        binding.imgbtnBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReferralPathway.this,ContactusActivity.class));
            }
        });
        ...
        binding.imgbtnProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReferralPathway.this,HomePage.class));
            }
        });
    }
}